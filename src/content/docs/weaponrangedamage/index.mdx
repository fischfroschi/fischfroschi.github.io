...
Use the creator to:
- Prototype damage envelopes without leaving the editor.
- Export a finalised curve as a proper asset for further refinement in the Curve Editor.
- Programmatically generate weapon-variant curves (e.g., short barrel vs. long barrel) from shared point arrays.
