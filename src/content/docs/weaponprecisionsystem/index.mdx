...
description: UE plugin for trace and view precision with full multiplayer support
---
...
> **Version:** v1.0.0
> **Engine:** UE 5.5 - 5.7
> **Download:** [Fab Store](https://www.fab.com/listings/69e95d4c-72ae-4763-a80d-a9bb4e818a3e)
...
1. The authority calls CalculateTraceDirection.  
2. The computed RecoilOffset is sent via Server_CalculateRecoilOffset.  
3. The server applies ViewPrecisionPercentage and sends the scaled offset back to the owning client via Client_AddRecoilControllerInput.  
